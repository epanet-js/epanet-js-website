...
image:
  { src: "/assets/blog/progress-report/2026-06/report-06-model-validation.webp", alt: "" }
...
The pipe library lets you build a reusable set of pipe materials, each with its own age-to-roughness table, so roughness can quickly be defined by accepted standards and then later calibrated.
...
<figure>
  <img
    src="/assets/blog/progress-report/2026-06/report-06-custom-attributes.webp"
    style="box-sizing: border-box;
                max-width:800px;
                width:100%;"
  />
...
<figure>
  <img
    src="/assets/blog/progress-report/2026-06/report-06-model-validation.webp"
    style="box-sizing: border-box;
                max-width:800px;
                width:100%;"
  />
...
<figure>
  <img
    src="/assets/blog/progress-report/2026-06/report-06-customer-allocation-scope-zones.webp"
    style="box-sizing: border-box;
                max-width:800px;
                width:100%;"
  />
