...
export const ui: Partial<Record<keyof typeof en, string>> = {
  ...
  "pricingTable.platform.title": "Plataforma",
  "pricingTable.platform.feature1": "Basada en web — sin instalación, en cualquier SO/navegador",
  "pricingTable.platform.feature2": "Primero en local — los datos permanecen en tu equipo",
  "pricingTable.platform.feature3": "Funciona sin conexión tras la primera carga",
  "pricingTable.platform.feature4": "Sin límite en el tamaño del modelo",
  "pricingTable.platform.feature5": "No requiere crear cuenta para empezar",
  "pricingTable.platform.feature6": "Interfaz en varios idiomas",
  "pricingTable.simulationEngine.title": "Motor de simulación",
  "pricingTable.simulationEngine.feature1": "Motor EPANET Toolkit 2.3.5",
  "pricingTable.simulationEngine.feature2": "Simulación en estado estacionario y período extendido (EPS)",
  "pricingTable.simulationEngine.feature3": "Demanda dependiente de la presión (PDD)",
  "pricingTable.simulationEngine.feature4": "Controles simples y basados en reglas",
  "pricingTable.simulationEngine.feature5": "Análisis de calidad del agua (químico, edad, trazas)",
  "pricingTable.simulationEngine.feature6": "Análisis de consumo energético",
  "pricingTable.simulationEngine.feature7": "Fórmulas de pérdida de carga (H-W, D-W, C-M)",
  "pricingTable.simulationEngine.feature8": "Opciones y tiempos de simulación",
  "pricingTable.simulationEngine.feature9": "Comprobación previa de datos de entrada",
  "pricingTable.networkEditing.title": "Edición de red",
  "pricingTable.networkEditing.feature1": "Dibujo de elementos en el mapa",
  ...
  "pricingTable.networkEditing.feature5": "Valores por defecto para el trazado de tuberías",
  ...
  "pricingTable.networkEditing.feature9": "Polígonos de zona: importar y visualizar",
  "pricingTable.elementProperties.title": "Propiedades de los elementos",
  "pricingTable.elementProperties.feature1": "Definición y curvas de bombas (1 punto / 3 puntos / multipunto)",
  "pricingTable.elementProperties.feature2": "Capacidad del depósito (diámetro o curva de volumen)",
  "pricingTable.elementProperties.feature3": "Controles de bombas (por nivel o por tiempo)",
  "pricingTable.elementProperties.feature4": "Año y materiales de tubería",
  "pricingTable.elementProperties.feature5": "Campos de datos personalizados",
  "pricingTable.demandManagement.title": "Gestión de la demanda",
  "pricingTable.demandManagement.customerPointsTitle": "Puntos de consumo (clientes)",
  "pricingTable.demandManagement.feature1": "Añadir, editar, mover y eliminar puntos de consumo",
  "pricingTable.demandManagement.feature2": "Importar desde Shapefile o GeoJSON",
  "pricingTable.demandManagement.feature3": "Tabla de datos de puntos de consumo",
  "pricingTable.demandManagement.allocationTitle": "Asignación",
  "pricingTable.demandManagement.feature4": "Asignación de demanda",
  "pricingTable.demandManagement.feature5": "Asignación basada en reglas",
  "pricingTable.demandManagement.feature6": "Asignación por zonas",
  ...
  "pricingTable.dataExchange.feature5": "Importación y exportación de modelos de terceros",
  "pricingTable.dataExchange.elevationDataTitle": "Datos de elevación",
  "pricingTable.dataExchange.feature6": "Asignación automática de cotas (MDT Mapbox Terrain)",
  "pricingTable.dataExchange.feature7": "Fuente de elevación personalizada (GeoTIFF)",
  "pricingTable.modelBuilding.title": "Construcción de modelos",
  "pricingTable.modelBuilding.feature1": "Importación de modelo GIS — creador heredado (Legacy)",
  "pricingTable.modelBuilding.feature2": "Importación de modelo GIS — creador Pro",
  ...
  "pricingTable.resultsVisualization.mapLayersTitle": "Mapa y capas",
  ...
  "pricingTable.resultsVisualization.symbologyTitle": "Simbología",
  "pricingTable.resultsVisualization.feature6": "Simbología del mapa (presión, caudal, demanda, cota piezométrica, …)",
  "pricingTable.resultsVisualization.feature7": "Flechas de dirección del caudal",
  "pricingTable.resultsVisualization.feature8": "Ajustes de tamaño y visibilidad de nodos",
  "pricingTable.resultsVisualization.chartsTablesTitle": "Gráficos y tablas",
  "pricingTable.resultsVisualization.feature9": "Gráfico rápido en el panel de elementos",
  "pricingTable.resultsVisualization.feature10": "Gráficos personalizados con múltiples elementos",
  "pricingTable.resultsVisualization.feature11": "Gráficos de datos de series temporales",
  "pricingTable.resultsVisualization.feature12": "Tablas de datos de elementos",
  "pricingTable.resultsVisualization.feature13": "Vista de perfil (Hydraulic Grade Line)",
  "pricingTable.advAnalysisOperations.title": "Análisis avanzado y operaciones",
  "pricingTable.advAnalysisOperations.networkReviewTitle": "Revisión de la red (comprobaciones)",
  "pricingTable.advAnalysisOperations.feature1": "Activos huérfanos",
  "pricingTable.advAnalysisOperations.feature2": "Verificación de proximidad",
  "pricingTable.advAnalysisOperations.feature3": "Cruces de tuberías",
  "pricingTable.advAnalysisOperations.feature4": "Rastreo de conectividad",
  "pricingTable.advAnalysisOperations.feature5": "Comprobación de atributos faltantes o no válidos",
  "pricingTable.advAnalysisOperations.feature6": "Comprobación de la rugosidad de tuberías",
  "pricingTable.advAnalysisOperations.feature7": "Comprobación de niveles en depósitos",
  "pricingTable.advAnalysisOperations.feature8": "Comprobación de curvas de bombas",
  "pricingTable.advAnalysisOperations.feature9": "Puntos de consumo sin asignar",
  "pricingTable.advAnalysisOperations.tracingTitle": "Rastreo y trazado",
  "pricingTable.advAnalysisOperations.feature10": "Rastreo de límites y selección",
  "pricingTable.advAnalysisOperations.feature11": "Rastreo aguas arriba y aguas abajo",
  "pricingTable.advAnalysisOperations.criticalityTitle": "Criticidad",
  "pricingTable.advAnalysisOperations.feature12": "Análisis de criticidad de válvulas",
  ...
  "pricingTable.reportingExports.title": "Informes y exportaciones",
  "pricingTable.reportingExports.feature1": "Exportar datos de elementos (Shapefile, CSV, XLSX, GeoJSON)",
  "pricingTable.reportingExports.feature2": "Exportar resultados de simulación (CSV, XLSX)",
  "pricingTable.cloudCollaboration.title": "Nube y colaboración",
  "pricingTable.cloudCollaboration.feature1": "Múltiples miembros del equipo",
  "pricingTable.cloudCollaboration.feature2": "Gestión de la organización",
  "pricingTable.cloudCollaboration.feature3": "Acceso de usuarios invitados y ajustes de privacidad",
  "pricingTable.cloudCollaboration.feature4": "Almacenamiento en la nube",
  "pricingTable.cloudCollaboration.feature5": "Almacenamiento de equipo",
  "pricingTable.cloudCollaboration.feature6": "Restauración a un punto en el tiempo (30 días Pro / 90 días Teams)",
  "pricingTable.cloudCollaboration.feature7": "Compartición de modelos",
  "pricingTable.supportLicensing.title": "Soporte y licencias",
  "pricingTable.supportLicensing.feature1": "Soporte de la comunidad",
  "pricingTable.supportLicensing.feature2": "Soporte profesional",
  "pricingTable.supportLicensing.feature3": "Soporte prioritario",
  "pricingTable.supportLicensing.feature4": "Gestión de licencias autoservicio",
  "pricingTable.supportLicensing.feature5": "Pago mediante factura",
  "pricingTable.supportLicensing.feature6": "Licencia individual nominativa",
  ...
  "pricingFaq.a8": `Completamos cuestionarios de seguridad para nuestros clientes del plan Enterprise.
    <p class="mt-3">
    Los planes Free, Pro y Teams son de autoservicio, por lo que esperamos que tu propio equipo realice su revisión de seguridad interna. Para facilitar esto al máximo, revisad nuestro <a href="https://help.epanetjs.com/Generic-Security-Questionnaire-3a0e18c9f0f6804f910fc8a69fa0c9ad" target="_blank" rel="noopener noreferrer" class="text-indigo-600 hover:text-indigo-800 underline hover:no-underline">cuestionario de seguridad genérico</a>, con respuestas a las preguntas que otras empresas de servicios públicos e ingeniería nos han planteado anteriormente, de modo que podáis rellenar vuestros propios formularios internos rápidamente. Si hay alguna pregunta que no esté cubierta, envíanos un <a href="mailto:support@epanetjs.com" class="text-indigo-600 hover:text-indigo-800 underline hover:no-underline">email</a> o <a href="https://cal.com/epanet-js/" class="text-indigo-600 hover:text-indigo-800 underline hover:no-underline">reserva una llamada</a>.</p>
  ...
  "security.questionnaireCallout.heading": "¿Estás revisando nuestra seguridad?",
  "security.questionnaireCallout.body":
    'Empieza por nuestro <a href="https://help.epanetjs.com/Generic-Security-Questionnaire-3a0e18c9f0f6804f910fc8a69fa0c9ad" target="_blank" rel="noopener noreferrer" class="text-indigo-600 hover:text-indigo-800 underline hover:no-underline">cuestionario de seguridad genérico</a>: responde a las preguntas que más nos plantean empresas de servicios públicos e ingeniería.',
  ...
  "security.faq.a0": "Completamos cuestionarios de seguridad para nuestros clientes Enterprise.<p class=\"mt-3\">Los planes Free, Pro y Teams requieren gestión autónoma por tu parte, y esperamos que tu organización realice su propia revisión interna de seguridad. Para facilitar esto al máximo, revisad nuestro <a href=\"https://help.epanetjs.com/Generic-Security-Questionnaire-3a0e18c9f0f6804f910fc8a69fa0c9ad\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-indigo-600 hover:text-indigo-800 underline hover:no-underline\">cuestionario de seguridad estándar</a> con respuestas a las preguntas que las empresas de servicios públicos e ingeniería nos han planteado anteriormente, de modo que puedas rellenar tus propios formularios internos rápidamente. Si alguna pregunta no está cubierta, envíanos un <a href=\"mailto:support@epanetjs.com\" class=\"text-indigo-600 hover:text-indigo-800 underline hover:no-underline\">email</a> o <a href=\"https://cal.com/epanet-js/\" class=\"text-indigo-600 hover:text-indigo-800 underline hover:no-underline\">reserva una llamada</a>.</p>",
  ...
  "security.ctaQuestions.footer":
    '¿Prefieres revisarlo por tu cuenta primero? Consulta nuestro <a href="https://help.epanetjs.com/Generic-Security-Questionnaire-3a0e18c9f0f6804f910fc8a69fa0c9ad" target="_blank" rel="noopener noreferrer" class="text-gray-200 underline hover:text-white hover:no-underline">cuestionario de seguridad genérico</a>.',
  ...
  "diagrams.localFirstFlow.caption1": "La aplicación se inicia",
  "diagrams.localFirstFlow.caption2": "El dispositivo se desconecta",
  "diagrams.localFirstFlow.caption3": "Subes el archivo local",
  ...
  "diagrams.fileTransfer.ariaLabel":
    "Diagrama: un archivo de modelo se transfiere entre dos ordenadores por email, unidad de red o USB, sin pasar por la nube.",
  "diagrams.fileTransfer.officeDesktop": "Ordenador en oficina",
  "diagrams.fileTransfer.siteLaptop": "Portátil",
  ...
  "diagrams.cloudOptional.ariaLabel":
    "Diagrama: un modelo se sincroniza en ambos sentidos con tres dispositivos a través de una nube, ya sea gestionada por nosotros o autoalojada.",
  "diagrams.cloudOptional.office": "Oficina",
  "diagrams.cloudOptional.site": "En el terreno",
  ...
  "diagrams.teamAccess.footer": "4 usuarios · Roles personalizados por miembro",

  "diagrams.dataRegions.ariaLabel":
    "Diagrama: tres regiones de datos (Europa, Estados Unidos y Asia-Pacífico). Cada una ejecuta la aplicación epanet-js junto a su propio almacenamiento de modelos, entregando los datos a los usuarios de esa zona sin salir de la región.",
  ...
  "diagrams.dataRegions.europeanUsers": "Usuarios en Europa",
  "diagrams.dataRegions.americanUsers": "Usuarios en EE. UU.",
  "diagrams.dataRegions.asiaPacificUsers": "Usuarios en Asia-Pacífico",
  "diagrams.dataRegions.models": "Modelos",
  "diagrams.dataRegions.footer": "Los modelos se guardan y se sirven desde la región que elijas",

  "diagrams.encryptedTransit.ariaLabel":
    "Diagrama: el tráfico entre tu equipo y el servicio epanet-js se cifra en tránsito mediante HTTPS y TLS.",
  "diagrams.encryptedTransit.yourMachine": "Tu equipo",
  "diagrams.encryptedTransit.footer": "Todo el tráfico se cifra en tránsito",

  "diagrams.cloudYourStorage.ariaLabel":
    "Diagrama: nosotros nos encargamos de ejecutar la aplicación epanet-js, mientras que los datos del modelo se leen y escriben en un sistema de almacenamiento gestionado por tu organización, como tu propio bucket de S3.",
  "diagrams.cloudYourStorage.appName": "App epanet-js",
  "diagrams.cloudYourStorage.weHostIt": "Alojamos y actualizamos",
  "diagrams.cloudYourStorage.yourStorage": "Tu almacenamiento",
  "diagrams.cloudYourStorage.s3Bucket": "S3 gestionado por ti",
  "diagrams.cloudYourStorage.readsAndWrites": "Lectura y escritura de modelos",
  "diagrams.cloudYourStorage.footer": "Tu región · Tus datos · Tu acceso",

  "diagrams.onPremDeployment.ariaLabel":
    "Diagrama: despliegue local (on-premise) en servidores propios que integra a tus usuarios, la aplicación epanet-js y los datos del modelo, todo dentro de tu red privada.",
  "diagrams.onPremDeployment.yourUsers": "Tus usuarios",
  "diagrams.onPremDeployment.appName": "App epanet-js",
  "diagrams.onPremDeployment.modelData": "Modelos",
  "diagrams.onPremDeployment.yourNetwork": "Tu red",
  "diagrams.onPremDeployment.footer": "Funciona íntegramente en tu propia infraestructura",
} as const;
