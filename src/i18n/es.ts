...
export const ui: Partial<Record<keyof typeof en, string>> = {
  ...
  "page.security.description": "Tú decides dónde residen los datos de tus modelos: por defecto en tu máquina, compartidos a través de nuestra nube, en un almacenamiento que tú gestiones o desplegados en local",
  ...
  "security.hero.primaryCta": "Contacta con nosotros",
  "security.hero.secondaryCta": "Lee nuestra política de privacidad",
  "security.badge.teams": "Teams",
  "security.badge.enterprise": "Enterprise",
  "security.setups.heading": "Encuentra tu configuración",
  "security.setups.subheading": "Desde mantener los archivos completamente en tu máquina local hasta ejecutar todo dentro de tu propia red corporativa, selecciona la opción que mejor se adapte a las políticas de seguridad y cumplimiento de tu equipo.",
  "security.setups.localFiles.title": "Ejecutar en tu máquina",
  "security.setups.localFiles.description": "Sin nube en absoluto. Archivos en tu sistema de archivos, compartidos de la forma en que ya lo haces.",
  "security.setups.cloudSharing.title": "Comparte modelos a través de la nube",
  "security.setups.cloudSharing.description": "Una copia sincronizada del modelo, roles de espacio de trabajo, cifrado en tránsito.",
  "security.setups.yourStorage.title": "Trae tu propio almacenamiento",
  "security.setups.yourStorage.description": "Nosotros alojamos la aplicación; los datos del modelo permanecen en el almacenamiento en la nube que tú gestionas.",
  "security.setups.onPremises.title": "Ejecutar en local (on-premises)",
  "security.setups.onPremises.description": "Todo el despliegue dentro de tu propia red.",
  "security.localFiles.heading": "Ejecutar en tu máquina",
  "security.localFiles.subheading": "Por defecto, tus proyectos de modelización hidráulica se crean, ejecutan y guardan completamente en tu máquina. Nunca se sube nada a nuestros servidores.",
  "security.localFiles.projectFiles.title": "Los archivos de proyecto permanecen en tu unidad local",
  ...
  "security.localFiles.shareModels.body1": "EN - Email a model to a colleague, put it on a shared drive, or copy it to a USB stick. Whoever receives the file opens it and picks up where you left off.",
  "security.localFiles.shareModels.body2": "Al no haber nuevas vías de datos, las políticas de seguridad actuales de tu empresa se aplican automáticamente.",
  ...
  "security.cloudSharing.workspaceRoles.body2": "Invita a un compañero por email, cambia su rol o elimínalo del espacio de trabajo, y su acceso cambiará de inmediato. Nadie fuera de tu espacio de trabajo puede ver tu red.",
  ...
  "security.faq.q3": "¿Utilizáis mi modelos hidráulicos o los datos de mis clientes para entrenar modelos de IA?",
  "security.faq.a3": "No. epanet-js utiliza la File System Access API del navegador. Cuando abres un proyecto, el navegador muestra el selector de archivos nativo del sistema, y a la aplicación se le concede acceso de lectura y escritura únicamente al archivo o carpeta específicos que elijas. No puede ver el resto de tu disco duro, tu sistema operativo ni tus carpetas compartidas en red.",
  "security.faq.q4": "¿Qué regiones de datos están disponibles para los proyectos sincronizados en la nube?",
  "security.faq.a4": "Soportamos regiones de datos en EE. UU., Europa y Asia-Pacífico. Cuando configuras un espacio de trabajo en la nube, eliges la región que se adapte a tus requisitos normativos, como el RGPD o los mandatos regionales de infraestructuras críticas. Tus datos se quedan fijados en esa región y nunca se replican ni se enrutan a través de fronteras geográficas.",
  ...
  "security.faq.a7": "La capa de almacenamiento es independiente del proveedor. Soportamos cualquier almacenamiento de objetos en la nube estándar o servicio compatible con S3, incluidos Amazon S3, Azure Blob Storage, Google Cloud Storage y opciones autoalojadas como MinIO. Tu equipo de TI mantiene el control total de las claves de cifrado y las políticas de acceso en los contenedores (buckets) de almacenamiento.",
  "security.faq.q8": "¿Cómo recibimos las actualizaciones de software y seguridad si hacemos un despliegue on-premises?",
