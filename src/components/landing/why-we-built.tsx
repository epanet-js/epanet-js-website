...
import ssaornil from "@assets/landing/ssaornil.webp?url";
import cgonzalez from "@assets/landing/cgonzalez.webp?url";
import mcalatayud from "@assets/landing/mcalatayud.webp?url";
      ...
      <div className="container mx-auto px-8 md:px-6 xl:px-24 relative">
        <div className="flex flex-col items-center md:gap-10 justify-center space-y-4 text-center mb-8 md:mb-12 lg:mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-10 mt-4">
            <div className="flex flex-col items-center space-y-4">
              <a
                href="https://www.linkedin.com/in/ssaornil/"
                className="text-gray-800 hover:text-blue-600 transition-colors duration-200"
              >
                <img
                  src={ssaornil}
            ...
            <div className="flex flex-col items-center space-y-4">
              <a
                href="https://www.linkedin.com/in/cesar-gonzalez-segura/"
                className="text-gray-800 hover:text-blue-600 transition-colors duration-200"
              >
                <img
                  src={cgonzalez}
            ...
            <div className="flex flex-col items-center space-y-4">
              <a
                href="https://www.linkedin.com/in/marcoscalatayud/"
                className="text-gray-800 hover:text-blue-600 transition-colors duration-200"
              >
                <img
                  src={mcalatayud}
